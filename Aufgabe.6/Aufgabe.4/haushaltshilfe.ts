    ...
    function handleChange(): void {
        ...
        for (let entry of formData) {
            ...
            if (entry[0] == "Groceries") {
                ...
                totalcost += prices;
                /* console.log("amazing", store, "Menge:", amount,
                     "Preis:", price,
                     "Preis*Menge:", prices,
                     "Gebühr*Menge:", gebühreneinkauf.toFixed(2),
                     "Preis*Menge + Gebühr*Menge", totalcost);*/

            } else if (entry[0] == "Bank") {
                let transfermon: HTMLInputElement = <HTMLInputElement>document.querySelector("#transfermon");
                let getmon: HTMLInputElement = <HTMLInputElement>document.querySelector("#getmon");
